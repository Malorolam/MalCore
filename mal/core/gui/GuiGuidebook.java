...
public class GuiGuidebook extends GuiScreen{
     ...
     */
    protected void drawGuiContainerForegroundLayer(boolean item, boolean recipe)
    {
        ...
        //draw the page text if there is any
    	int l = (recipe||item)?(160):(60);
		GL11.glScalef(0.5f, 0.5f, 0.5f);
        String text = instance.getPage(currentPage).getText();
        if(text != null && text != "")
        	this.fontRendererObj.drawSplitString(text, guiLeft*2+10, guiTop*2+l, 490, 4210752);
     ...
     */
    protected void drawGuiContainerBackgroundLayer(boolean item, boolean recipe)
    {
        ...
        if(item)
            this.drawTexturedModalRect(guiLeft+l, guiTop+35, 0, 210, 18, 18);
        if(recipe)
        {
        	this.drawTexturedModalRect(guiLeft+126, guiTop+36, 0, 228, 22, 18);
        	
        	this.drawTexturedModalRect(guiLeft+71, guiTop+17, 0, 210, 18, 18);
        	this.drawTexturedModalRect(guiLeft+89, guiTop+17, 0, 210, 18, 18);
        	this.drawTexturedModalRect(guiLeft+107, guiTop+17, 0, 210, 18, 18);
        	this.drawTexturedModalRect(guiLeft+71, guiTop+35, 0, 210, 18, 18);
        	this.drawTexturedModalRect(guiLeft+89, guiTop+35, 0, 210, 18, 18);
        	this.drawTexturedModalRect(guiLeft+107, guiTop+35, 0, 210, 18, 18);
        	this.drawTexturedModalRect(guiLeft+71, guiTop+53, 0, 210, 18, 18);
        	this.drawTexturedModalRect(guiLeft+89, guiTop+53, 0, 210, 18, 18);
        	this.drawTexturedModalRect(guiLeft+107, guiTop+53, 0, 210, 18, 18);
        }
    }
    
    private void drawItems(boolean item, boolean r)
    {
        ...
        {
        	int l = (r)?(151):(116);
        	itemRender.renderItemAndEffectIntoGUI(this.fontRendererObj, this.mc.getTextureManager(), is, guiLeft+l, guiTop+36);
        	itemRender.renderItemOverlayIntoGUI(this.fontRendererObj, this.mc.getTextureManager(), is, guiLeft+l, guiTop+36);
        }
    ...
    public void drawScreen(int i, int j, float f)
    {
    	...
    	drawGuiContainerBackgroundLayer(item, recipe);
    	GL11.glDisable(GL12.GL_RESCALE_NORMAL);
        RenderHelper.disableStandardItemLighting();
        GL11.glDisable(GL11.GL_LIGHTING);
        GL11.glDisable(GL11.GL_DEPTH_TEST);
        ...
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        GL11.glDisable(GL11.GL_LIGHTING);
    	drawGuiContainerForegroundLayer(item, recipe);
        GL11.glEnable(GL11.GL_LIGHTING);
        drawItems(item, recipe);
        GL11.glPopMatrix();
        GL11.glEnable(GL11.GL_LIGHTING);
